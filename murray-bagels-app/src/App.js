...
const BagelLandingPage = () => {
  ...
  useEffect(() => {
    console.log("BagelLandingPage rendered");
  ...
  const data = [
    ...
    { name: "Coffee (Small, Special Blend)", value: 1.8, color: "#6F4E37" },
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center px-4">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg text-amber-700 mb-6">
              New York's Finest Handcrafted Bagels Since 1996
            </p>
            <p className="text-amber-700 mb-6">
              500 6th Avenue, New York, NY 10011
            </p>
            ...
            <div style={sketchStyle} className="relative">
              ...
              >
                ...
                <g className="transform -rotate-6 translate-x-10">
                  {/* Paper wrapper */}
                  <path
                    d="M50 120 Q120 100, 250 120 Q280 150, 300 200 Q250 250, 150 240 Q80 230, 50 180 Q40 150, 50 120"
                    fill="#f5f5dc"
                    stroke="#888"
                    strokeWidth="1"
                  />
                ...
                <g transform="translate(240, 200) scale(0.7)">
                  <path
                    d="M20 30 Q20 10, 40 10 L80 10 Q100 10, 100 30 L90 90 Q90 100, 80 100 L40 100 Q30 100, 30 90 Z"
                    fill="#f5f5dc"
                    stroke="#888"
                    strokeWidth="2"
                  />
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
              ...
              <div className="mt-4 border-t pt-4">
                <div className="flex justify-between mb-2">
                  <span className="font-semibold">
                    Plain Tofu Sand Health Bagel
                  </span>
                  <span>$4.05</span>
                </div>
                <div className="flex justify-between mb-2">
                  <span className="font-semibold">
                    Coffee (Small, Special Blend)
                  </span>
                  <span>$1.80</span>
                </div>
                <div className="flex justify-between mb-2">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex-1 max-w-md">
              ...
              <p className="mb-4">
                At Murray's Bagels, we're committed to making authentic New York
                bagels using traditional methods that have been perfected since
                1996.
              </p>
              <p className="mb-4">
                Our bagels are kettle-boiled and then baked to perfection,
                giving them that distinctive chewy interior and crisp exterior
                that New York bagels are famous for.
              </p>
              <p className="mb-4">
                We offer a variety of options including our popular Health
                Bagel, perfect for our plant-based customers seeking nutritious
                alternatives like our Plain Tofu Sandwich.
              </p>
              <p>
                Pair your bagel with our house Special Blend coffee for the
                perfect New York breakfast experience!
              </p>
